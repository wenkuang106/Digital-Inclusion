...
organizations = pd.read_csv('SunsetPark.csv') ## insert the .CSV file containing the data 
coalitions = pd.read_csv('') ## insert the .CSV file containing the data 
locations = pd.read_csv('SunsetParkLocation.csv') ## insert the .CSV file containing the data 
...
#### checking the columns within the uploaded CSV files

organizationsUpdated.columns
coalitionsUpdated.columns
locationsUpdated.columns
